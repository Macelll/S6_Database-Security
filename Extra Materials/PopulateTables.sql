...
Insert Into Customer( CustID , CustName , PaymentCardNumber , PhoneNumber , Country )
Values
('C0006','John',EncryptByAsymKey(AsymKey_ID('AsymKey2'),'12345611789'),'0116567678','MAS')
...
Select  CustID , CustName , Convert(varchar, DecryptByAsymKey(AsymKey_ID('AsymKey2'),PaymentCardNumber)) As PaymentCardNumber, PhoneNumber , Country 
From Customer Where CustID in ('C0001','C0002')
...
Insert Into [Order] (CustID, OrderDate) Values ('C0001',getdate()-0.5)
...
Insert Into [Order] (CustID, OrderDate) Values ('C0002',getdate()-0.4)
